...
function crearFormulario() {
    ...
    <div class="formulario_mensaje my-2" id="formulario_mensaje">
		<p><i class="fas fa-exclamation-triangle"></i><b>Por favor rellena el formulario correctamente.<b> </p>
	</div>
<input type="submit" class="button formulario_boton mx-auto  bg-color2" value="Registrarse" >
...
async function guardarUsuario({ nombre, apellido, email, password }) {
